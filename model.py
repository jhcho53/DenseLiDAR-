...
from submodules.refine import ResidualRefineBlock, DilatedRefineBlock
...
class DenseLiDAR(Module):
    def __init__(self, bs):
        ...
        self.refine_block = DilatedRefineBlock(in_ch=1, mid_ch=32)
    ...
    def forward(self, image, sparse, pseudo_depth_map, device):
        ...
        residual_refined = self.refine_block(residual)
