...
def dataloader(filepath, mode='train'):
    ...
    left_pseudo_depth = 'proj_depth/velodyne_raw/image_02'
    right_pseudo_depth =  'proj_depth/velodyne_raw/image_03'
    ...
    for seq in seqs:
        ...
        # pseudo depth map
        left_pseudo_depth = os.path.join(filepath_pd, seq, 'proj_depth/velodyne_raw/image_02')
        ...
        right_pseudo_depth = os.path.join(filepath_pd, seq, 'proj_depth/velodyne_raw/image_03')
